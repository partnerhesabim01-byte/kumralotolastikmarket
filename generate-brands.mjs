...
const BRANDS = [
  ...
  },
  {
    ...
    name: "Lassa",
    origin: "Türkiye",
    tag: "Yerli üretimde lider, Brisa güvencesiyle",
  ...
  },
  {
    ...
    tag: "Ekonomik segmentte Apollo Tyres güvencesi",
  ...
  },
  {
    ...
    name: "Continental",
    origin: "Almanya",
    tag: "Premium teknolojiyle öne çıkan",
  ...
  },
  {
    ...
    name: "Hankook",
    origin: "Güney Kore",
    tag: "Geniş ürün gamıyla öne çıkan",
  ...
  },
  {
    ...
    tag: "Uygun fiyatlı segmentte Hankook güvencesi",
    lead: "Laufenn, Hankook bünyesinde faaliyet gösteren, uygun fiyatlı segmentte güvenilir bir alternatif sunan bir markadır.",
    types: ["Yaz Lastiği", "Kış Lastiği", "4 Mevsim Lastiği"],
    why: "Laufenn, Hankook kalite standartlarından uygun bütçeyle faydalanmak isteyen müşterilerimiz için pratik bir seçenektir.",
  },
];
